...
def victory():
    class MyWindow(Tk):
        ...
        def __init__(self):
            ...
            button = Button(self, text=" Quitter ", fg="red", bg="blue")
...
def drawn():
    class MyWindow(Tk):
        ...
        def __init__(self):
            super().__init__()
            label = Label(self, text="Match", fg="white", bg="#4A919E")
            label.pack(side="top", fill='x')

            button = Button(self, text="1 Player", fg="white", bg="#FF00FF", command=self.p_vs_bot)
            button.place(x=150,y=110)
